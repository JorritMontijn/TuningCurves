function [vecSpikeTimes,vecEventStarts] = getGeneratedSpikingGaussian(m,T,tau,L_b,L_s)
	...
	vecISIb = normrnd(1/L_b,1/L_b,[1 round(L_b*m*tau*2)]);
	vecISIb(vecISIb<0)=[];
	vecBaseSpikeTimes = cumsum(vecISIb);
	vecISIs = normrnd(1/L_s,1/L_s,[1 round(L_s*m*tau*2)]);
	vecISIs(vecISIs<0)=[];
